...
const MENTORS = {
  ...
  kayo: {
    ...
    photo: "https://i.imgur.com/wdXqRJz.jpeg",
  ...
  return (
    <div className="min-h-screen bg-[#0b1120] text-slate-200 pb-20 animate-[fadeIn_0.5s_ease-out]">
      ...
      <Header 
        ...
        avatarUrl={role === UserRole.MENTOR ? loggedMentor.photo : MENTORS.muzeira.photo} // Aluno vê o principal, Mentor vê sua própria foto
      />
